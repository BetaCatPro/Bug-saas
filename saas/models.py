...
class Project(models.Model):
    ...
    use_space = models.IntegerField(verbose_name='项目已使用空间', default=0, help_text='B')
...
class FileRepository(models.Model):
    ...
    file_size = models.IntegerField(verbose_name='文件大小', null=True, blank=True, help_text='B')
